...
const hotpockets = [
  {
    ...
    product_description:
      "Melty parmesan, cheddar, reduced-fat provolone, & mozzarella cheeses all wrapped up in one delicious pocket. A hearty snack made with loads of real cheese that's ready in minutes. 5 Hot Pockets® sandwiches per box. Total Weight: 602g",
    price_a: 50,
    price_b: 56,
    img: fourCheese,
  ...
  },
  {
    ...
    product_description:
      "Tender, sliced steak with cheddar cheese and sauce all wrapped up in one delicious pocket. A hearty snack made with loads of premium meat and cheese that's ready in minutes. 5 Hot Pockets® sandwiches per box. Total Weight: 637g",
    price_a: 50,
    price_b: 56,
    img: steakCheddar,
  ...
  },
  {
    ...
    product_description:
      "Savory beef, reduced-fat mozzarella cheese, peppers, onions, and sauce all wrapped up in one delicious pocket. A hearty snack made with loads of premium meat and cheese that's ready in minutes. 5 Hot Pockets® sandwiches per box. Total Weight: 637g",
    price_a: 50,
    price_b: 56,
    img: phillySteak,
  ...
  },
  {
    ...
    product_description:
      "Unapologetically spicy steak, jalapeños and cheese sauce all wrapped up in one delicious pocket. 50% Larger* as compared to a traditional 4.5oz HOT POCKETS sandwich. 4 Hot Pockets® frozen sandwiches per box. Total Weight: 765g",
    price_a: 60,
    price_b: 75,
    img: steakNacho,
  ...
  },
  {
    ...
    product_description:
      "Loads of white meat chicken and melty cheddar cheese wrapped in a buffalo blasted crust with a spicy buffalo sauce 50% Larger* as compared to a traditional 4.5oz Hot Pockets® sandwich. 4 Hot Pockets® frozen sandwiches per box. Total Weight: 765g",
    price_a: 60,
    price_b: 75,
    img: buffalo,
