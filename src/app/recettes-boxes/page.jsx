...
import recettes from "@/data/en/recettes-boxes";
import Image from "next/image";
import banner from "../../../public/recettes-boxes/recettes-boxes-banner.svg";
...
export default function Stouffers() {
  ...
  const addSubscriber = (e) => {
    ...
    const params = {
      email: email,
      groups: ["108264943552300460"], // Atellier-Boxes Group ID
      status: "active",
    };
            ...
            >
              ...
              <div className="flex justify-between items-center h-[50px] mx-4 text-xs md:text-sm">
                ...
                <button
                  ...
                  id={`RB-${replaceSpacesWithHyphens(meal.name)}-more-info`}
                >
                  i
                </button>
              </div>
          ...
          <div className="flex justify-center flex-col items-center gap-4 border-t border-slate-100 pt-4">
            ...
            <div className="flex justify-center gap-4">
              <button
                ...
                id={`RB-${replaceSpacesWithHyphens(
                  currentMeal?.name
                )}-${priceType}-disliked`}
              >
