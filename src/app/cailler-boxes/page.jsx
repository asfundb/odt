...
import cailler from "@/data/en/cailler-boxes";
import Image from "next/image";
import banner from "../../../public/cailler-boxes/cailler-boxes-banner.svg";
...
export default function Stouffers() {
  ...
  const addSubscriber = (e) => {
    ...
    const params = {
      email: email,
      groups: ["108258675436553842"], // Cailler-Boxes Group ID
      status: "active",
    };
            ...
            >
              ...
              <div className="flex justify-between items-center h-[50px] mx-4 text-xs md:text-sm">
                ...
                <button
                  ...
                  id={`CB-${replaceSpacesWithHyphens(meal.name)}-more-info`}
                >
                  i
                </button>
              </div>
          ...
          <div className="flex justify-center flex-col items-center gap-4 border-t border-slate-100 pt-4">
            ...
            <div className="flex justify-center gap-4">
              <button
                ...
                id={`CB-${replaceSpacesWithHyphens(
                  currentMeal?.name
                )}-${priceType}-disliked`}
              >
