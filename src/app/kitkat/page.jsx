  ...
  return (
    <div className="w-screen h-full">
      ...
      <div className=" mx-10 lg:mx-48 my-16 text-black flex flex-col items-center">
        <div className="badge bg-sky-400 border-none badge-lg py-4 text-white mb-8 text-xs md:text-base ">
          Select the flavours you'd like to be invited to taste by clicking the
          card
        </div>
          ...
          {kitkatBall.map((meal, index) => (
            ...
            >
              <Image
                src={meal.img}
                alt={meal.name}
                className="rounded-t-2xl hover:scale-125 hover:translate-y-5 transition duration-500 cursor-pointer object-cover"
              />
