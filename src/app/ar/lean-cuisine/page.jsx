...
import leanCuisine from "@/data/ar/lean-cuisine";
import Image from "next/image";
import banner from "../../../../public/lean-cuisine/lean-cuisine-banner-ar.svg";
...
export default function Stouffers() {
  ...
  const addSubscriber = (e) => {
    ...
    const params = {
      email: email,
      groups: ["110423217100818178"], // KSA-Lean-Cuisine Group ID
      status: "active",
    };
            ...
            >
              ...
              <div className="flex justify-between items-center h-[50px] mx-4 text-xs md:text-sm">
                ...
                <button
                  ...
                  id={`KSA-LC-${replaceSpacesWithHyphens(meal.name)}-more-info`}
                >
                  i
                </button>
              </div>
          ...
          <div className="flex justify-center flex-col items-center gap-4 border-t border-slate-100 pt-4">
            ...
            <div className="flex justify-center gap-4">
              <button
                ...
                id={`KSA-LC-${replaceSpacesWithHyphens(
                  currentMeal?.name
                )}-${priceType}-disliked`}
              >
