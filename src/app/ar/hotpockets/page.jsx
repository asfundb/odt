...
import hotpockets from "@/data/ar/hotpockets";
import Image from "next/image";
import banner from "../../../../public/Hotpocket/hot-pocket-banner-ar.svg";
...
export default function Stouffers() {
  ...
  const addSubscriber = (e) => {
    ...
    const params = {
      email: email,
      groups: ["109985660796929739"], // KSA-Hotpockets Group ID
      status: "active",
    };
