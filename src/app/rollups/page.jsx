    ...
    <div className="w-screen h-full">
      ...
      <div className=" mx-10 lg:mx-48 my-16 text-black flex flex-col items-center">
        <div className="badge bg-sky-400 border-none badge-lg py-4 text-white mb-8">
          <p>Select the flavours you would like</p>
          <p>to be invited to taste by clicking the card</p>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {rollups.map((meal, index) => (
            <div
              key={index}
            ...
            >
              <Image src={meal.img} alt={meal.name} className="rounded-t-2xl" />
